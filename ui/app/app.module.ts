...
import { TopicHeader } from './components/tutorial/topic-headers/topicHead.component';
...
import { ProfileDisplayComponent } from './components/student/student-profile-display/profileDisplay.component';
...
@NgModule({
  declarations: [
    AppComponent, AppHeader, AppFooter,StudentComponent,ProfileDisplayComponent,
    Topics, TopicHeader, HomeComponent, YoutubePlayerComponent, EditorComponent, SignUp,Login,Logout 
  ],
  imports: [
    BrowserModule,
    HttpClientModule,
  ...
  providers: [TutorilaService, CodeExecutorService,UserSignupService,UserDataService,{provide: MAT_DIALOG_DEFAULT_OPTIONS, useValue: {hasBackdrop: false}}],
